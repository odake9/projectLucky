...
<body>
  ...
  <header class="w3-card w3-round-large">
    <a href="staff_menu.php" class="dashboard-btn">← Back</a>
    <h1>~ Lucky Milk Tea (Staff View) ~</h1>
  </header>
    ...
    <?php while($row = $result->fetch_assoc()) { ?>
      <div class="menu-item" data-category="<?php echo $row['category']; ?>">
        ...
        <div class="w3-container w3-padding">
          ...
          <form action="staff_view_menu.php" method="POST">
...
if (isset($_POST['add_to_cart'])) {
  ...
  $_SESSION['cart'][] = $item;
  header("Location: staff_view_menu.php");
  exit();
}
